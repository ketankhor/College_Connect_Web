		...
		<ul>
			...
			<li class="has-subnav">
				...
				<ul>
					...
					<li>
						<a class="subnav-text" href="ViewAnsEventComment.jsp">
							 View Event Comment
						</a>
					</li>
					<li>
						<a class="subnav-text" href="ViewAnsNoticeComment.jsp">
							 View Notice Comment
						</a>
					</li>
					...
					<div class="w3l-table-info">
					  <h3></h3>
						...
						try
						{
							...
							PreparedStatement ps1 = con.prepareStatement("select * from commentreq_tbl");
					     ...
					     %>
						  ...
						  <tr>
							...
							<td><a href="AnsReqComment.html">Comment</a></td>
