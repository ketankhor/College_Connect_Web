						...
						try
						{
					     ...
					     %>
						  ...
						  <tr>
							...
							<td><a href="ViewCommentJob.jsp?Id=<%=rs.getInt(1)%>">View Comment</a></td>
						  ...
						  <%
							...
							{
								PreparedStatement ps2 = con.prepareStatement("select * from job_tbl where JobBranch=?");
									...
									%>
									     <tr>
												...
												<td><%=rss.getString(4)%></td>
							                     <td><a href="ViewCommentJob.jsp">View Comment</a></td>
