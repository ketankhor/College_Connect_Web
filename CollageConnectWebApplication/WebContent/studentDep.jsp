		...
		<ul>
			...
			<li class="has-subnav">
				...
				<ul>
					...
					<li>
						<a class="subnav-text" href="ViewNoticeComment.jp">
							 View Notice Comment
						</a>
					</li>
					...
					<div class="w3l-table-info">
					  <h3></h3>
						...
						try
						{
							...
							if(search==null)
							{
							PreparedStatement ps1 = con.prepareStatement("select * from hodnotice_tbl");
					     ...
					     %>
						  ...
						  <tr>
							...
							<td><a href="ViewCommentHodNotice.jsp?Id=<%=rs.getInt(1)%>">View Comment</a></td>
						  ...
						  <%
							...
							{
								PreparedStatement ps2 = con.prepareStatement("select * from hodnotice_tbl where Branch=?");
